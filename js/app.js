(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const designForm = document.querySelector(".design__form");
        if (!designForm) return;
        const steps = designForm.querySelectorAll(".form-quote__wrapper");
        let currentStep = 0;
        function updateButtons() {
            const buttonContainer = designForm.querySelector("#buttonContainer");
            if (currentStep === 0) buttonContainer.innerHTML = `\n\t\t \t<button type="button" id="startOverBtn" class="form-quote__btn btn" style="visibility: hidden;">Start Over</button>\n\t\t \t<button type="button" id="nextBtn" class="form-quote__btn btn">Go to Step 2</button>`; else if (currentStep === 1) buttonContainer.innerHTML = `\n\t\t\t<button type="button" id="startOverBtn" class="form-quote__btn btn">Start Over</button>\n\t\t\t<button type="button" id="nextBtn" class="form-quote__btn btn">Next</button>`; else if (currentStep === 2) buttonContainer.innerHTML = `\n\t\t\t<button type="button" id="startOverBtn" class="form-quote__btn btn">Start Over</button>\n\t\t\t<button type="submit" id="submitBtn" class="form-quote__btn btn">Submit Request</button>`;
        }
        ...
        buttonContainer.addEventListener("click", (e => {
            ...
            } else if (e.target.id === "startOverBtn") {
                e.preventDefault();
                currentStep = 0;
                updateStepDisplay();
            }
